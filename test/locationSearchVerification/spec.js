...
describe("Assignment 1", () => {
  ...
  it("Verify that all listing tiles in the search results display the correct location based on the search criteria", async () => {
    ...
    // Verify that all listings have the correct location
    const allListingsMatch = await HomePage.verifyListingsCity("Houston, TX");
    WebdriverUtils.toBe("All listing tiles have the correct location", allListingsMatch, true);
